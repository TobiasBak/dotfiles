...
Use `../rebuild.sh` for WSL NixOS, Home Manager, tool package, and skill-link changes.
The script updates the private skills checkout, builds the exact system closure,
and switches to it.
