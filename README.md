...
- `configs/`: Shared program configs used by both OS installers where applicable.
  ...
  - Windows installers symlink supported shared configs (PowerShell aliases, VS Code, Discord, Pi config/extensions/prompts, and Codex CLI config/prompts) into their Windows locations and install Pi/Codex CLI skills from sibling skills repo `../skills` relative to this dotfiles repo.
